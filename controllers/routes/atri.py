...
class Atri:
	def __init__(self, state: Any):
		...
		self.hero_section = state["hero_section"]
	...
	def Header(self, new_state):
		...
		global default_state
		self._Header = Div(new_state, default_state["Header"])
	...
	def hero_section(self):
		self._getter_access_tracker["hero_section"] = {}
		return self._hero_section
	@hero_section.setter
	def hero_section(self, new_state):
		self._setter_access_tracker["hero_section"] = {}
		global default_state
		self._hero_section = Div(new_state, default_state["hero_section"])
	...
	def _to_json_fields(self):
		return {
			...
			"Flex7": self._Flex7,
			"Flex8": self._Flex8,
			"hero_section": self._hero_section,
			"Flex11": self._Flex11,
			"Flex9": self._Flex9,
			"Flex10": self._Flex10,
			"Flex12": self._Flex12,
